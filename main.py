...
logo_img = PhotoImage(file="/img/logo1.png")
...
image=PhotoImage(file="/img/canvas.png")
...
image1=PhotoImage(file="/img/canvas2.png")
...
# button_img = PhotoImage(file="/img/button_reset.png")
# button_img_label=Label(image=button_img)
# button=Button(image=button_img, command=reset)
# button.grid(row=3, column=3)


image2=PhotoImage(file="/img/img_bottom.png")
cpm=StringVar()
...
image3=PhotoImage(file="/img/img_bottomgreen.png")
wpm=StringVar()
...
image4=PhotoImage(file="/img/img_bottomblue.png")
var1=StringVar()
...
image5=PhotoImage(file="/img/img_bottomrose.png")
var=StringVar()
